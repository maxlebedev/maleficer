use crate::{gamelog::GameLog, InBackpack, Name, Position, WantsToPickupItem, WantsToDrinkPotion, CombatStats, Potion, WantsToDropItem};
use specs::prelude::*;
